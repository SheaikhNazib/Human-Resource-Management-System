      ...
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-blue-500 text-white text-sm font-medium hover:bg-blue-600 transition-colors shadow-sm hover:shadow-md"
          >
            <svg
          ...
          <div className="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-zinc-800 dark:to-zinc-800 px-6 py-8 sm:px-8">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col gap-3 text-sm">
                <div className="bg-white dark:bg-zinc-900 rounded-lg px-4 py-2.5 shadow-sm border border-zinc-200 dark:border-zinc-700">
