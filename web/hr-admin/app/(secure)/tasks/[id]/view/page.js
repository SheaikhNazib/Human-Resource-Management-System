    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 py-8 px-4 sm:px-6 lg:px-8">
              ...
              {workItemsLoading ? (
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                  ...
                  <p className="text-gray-400 text-sm mt-1">
                    Add your first work item to get started.
                  </p>
                </div>
              ) : (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-200">
              ...
              <div className="flex items-center justify-center">
                <span
                  className={`${statusInfo.color} text-white px-6 py-2 rounded-full font-semibold text-lg shadow-lg`}
                >
                  {statusInfo.name}
                </span>
              </div>
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className={`ml-auto px-3 py-1 rounded-full text-xs font-medium ${priorityInfo.color}`}
                  >
                    {priorityInfo.label}
                  </span>
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-6 animate-scaleIn">
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600">
                Search and add employees to this task. Click on employees to
                add/remove them.
              </p>
              <p className="text-xs text-blue-600 mt-1">
                Selected: {selectedEmployees.length} employees - IDs: [
      ...
      {notification && (
        <div className="fixed top-6 right-6 z-50">
          <div
            className={`max-w-sm px-4 py-3 rounded-lg shadow-lg flex items-center gap-3 ${
          ...
          >
            ...
            <button
              ...
              className="text-white opacity-90 hover:opacity-100 font-bold"
            >
              ×
            </button>
          </div>
          ...
          {filtered.map((e) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => add(e.id)}
                className={`w-full text-left px-4 py-3 hover:bg-blue-50 flex items-center gap-3 border-b border-gray-100 last:border-b-0 ${
